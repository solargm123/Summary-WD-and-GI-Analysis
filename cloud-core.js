(function(global){
  ...
  function injectDock(){
    ...
    const style=document.createElement('style');style.textContent=`
      ...
      @media(max-width:980px){#solarCloudDock{width:max-content;min-width:max-content}.solar-cloud-topbar-host{order:10;flex:1 0 100%;width:100%;padding-top:8px;margin-left:0;justify-content:flex-start}}
