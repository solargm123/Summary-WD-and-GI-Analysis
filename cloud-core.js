(function(global){
  ...
  function injectDock(){
    ...
    const style=document.createElement('style');style.textContent=`
      #solarCloudDock{position:sticky;top:0;z-index:9998;display:flex;align-items:center;gap:7px;width:max-content;max-width:calc(100vw - 20px);margin:0 auto 10px;padding:7px 9px;background:#102432ee;color:#e8f3f5;border:1px solid #426171;border-top:0;border-radius:0 0 12px 12px;box-shadow:0 12px 30px #0004;font:500 11px 'Bai Jamjuree',sans-serif;backdrop-filter:blur(10px);overflow-x:auto}
