(function(global){
  ...
  function analysisUrl(project){const page=project.analysis_type==='working_day'?'working-day-analysis.html':project.analysis_type==='global_irradiance'?'global-irradiance-analysis.html':'pr-report.html';return `${page}?v=20260915-header-actions1&project=${encodeURIComponent(project.id)}`}
  ...
  function localKeys(type){
    ...
    if(type==='global_irradiance')return ['selectedPlants','selectedTrendPlants','activeStatusFilter','selectedPeriod','fullDataLoaded','filters'];
