(function(global){
  ...
  function injectDock(){
    ...
    const style=document.createElement('style');style.textContent=`
      ...
      .solar-cloud-topbar-host{position:relative;z-index:1;clear:both;display:flex;align-items:center;justify-content:center;width:100%;padding:8px 12px 10px;margin:0 auto;box-sizing:border-box;overflow-x:auto}
    ...
    const pageHeader=document.querySelector('header'),host=document.createElement('div');host.className='solar-cloud-topbar-host';host.appendChild(dock);if(pageHeader)pageHeader.appendChild(host);else document.body.prepend(host);setLanguage(interfaceLanguage);
