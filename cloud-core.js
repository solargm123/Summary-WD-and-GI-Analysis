(function(global){
  ...
  function injectDock(){
    ...
    const pageHeader=document.querySelector('header'),host=document.createElement('div');host.className='solar-cloud-topbar-host';host.appendChild(dock);if(pageHeader)pageHeader.insertAdjacentElement('afterend',host);else document.body.prepend(host);setLanguage(interfaceLanguage);
