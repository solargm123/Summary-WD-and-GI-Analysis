...
## Default execution
Clarify if needed -> classify layer -> load only relevant skill -> lock protected behavior -> smallest edit -> targeted test -> regression guard -> review diff -> one coherent commit -> lightweight performance log.
