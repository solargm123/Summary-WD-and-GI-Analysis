...
Commit ไฟล์หน้าเว็บทั้ง 7 ไฟล์ แล้วรอ GitHub Pages Deploy สำเร็จ จากนั้นเปิดหน้าเว็บใหม่ด้วย `Ctrl + Shift + R` เพื่อไม่ให้เบราว์เซอร์ใช้ไฟล์เก่า
...
## 7. ตรวจหน้าตาและการใช้งาน

- ทุกหน้าต้องสลับภาษาไทย/English ได้
- ทุกหน้าต้องสลับโหมดมืด/สว่างได้
- ปุ่มและประเภทการวิเคราะห์ต้องใช้ไอคอนรูปแบบเดียวกัน
- ตรวจบนคอมพิวเตอร์และโทรศัพท์ว่าไม่มีปุ่มหรือตารางล้นจอ
- หน้า Performance Ratio เป็นเพียงโครงสร้างเตรียมไว้ ยังไม่เปิดใช้สูตรคำนวณ
